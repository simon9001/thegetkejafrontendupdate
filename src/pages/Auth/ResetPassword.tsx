                            ...
                            <div className="h-full flex items-center justify-center">
                                <div className="w-full max-w-xs mx-auto px-5 py-6">
                                    <div className="text-center">
                                        ...
                                        <h2 className="text-xl font-bold text-[#50757A] mb-2">Success!</h2>
                            ...
                            >
                                ...
                                <div className="absolute bottom-12 left-10 right-10 text-white z-20">
                                    ...
                                    <h2 className="text-3xl font-black mb-3 leading-tight">
                                        Secure Your <span className="text-[#C0D6DF]">Future</span>
                                    </h2>
                                </div>
                            </motion.div>
                        </div>
                        ...
                        <div className="h-full flex items-center justify-center">
                            <div className="w-full max-w-xs mx-auto px-5 py-6 relative">
                                ...
                                <div className="text-center mb-5">
                                    <h1 className="text-2xl font-bold text-[#50757A] mb-0.5">Reset Password</h1>
                                    <p className="text-[#C0D6DF] text-xs font-medium">Create a new password</p>
                                </div>

                                {/* Icon */}
                                <div className="flex justify-center mb-4">
                                    <div className="w-14 h-14 bg-[#C0D6DF]/10 rounded-full flex items-center justify-center">
                                        <Lock className="w-7 h-7 text-[#C0D6DF]" />
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                className="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-[#C0D6DF] focus:border-[#C0D6DF] text-xs pr-8"
                                                required
                                            />
                                            <button 
                                                type="button" 
                                                onClick={() => setShowPassword(!showPassword)} 
                                                className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#C0D6DF]"
                                            >
                    ...
                    <div className="hidden lg:block lg:w-1/2 h-full relative overflow-hidden bg-[#50757A]">
                        ...
                        >
                            ...
                            <div className="absolute bottom-12 left-10 right-10 text-white z-20">
                                <div className="w-10 h-1 bg-[#C0D6DF] mb-4 rounded-full"></div>
                                <h2 className="text-3xl font-black mb-3 leading-tight">
                                    Your Privacy, <span className="text-[#C0D6DF]">Our Commitment</span>
                                </h2>
                            </div>
                        </motion.div>
                    </div>
