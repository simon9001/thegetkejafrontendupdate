                    ...
                    >
                      {isAuthenticated && user ? (
                        <>
                          ...
                          <MenuItem to="/profile"  icon={<User className="w-4 h-4" />}           label="Profile" />
                          <MenuItem to="/trips"    icon={<Calendar className="w-4 h-4" />}        label="Trips" />
                          <MenuItem to="/messages" icon={<MessageCircle className="w-4 h-4" />}   label="Messages" />
                          <MenuItem
                            to="/saved"
                          ...
                          <MenuItem to="/settings" icon={<Settings className="w-4 h-4" />} label="Settings" />
                        ...
                        <>
                          ...
                          />
                          <MenuItem to="/become-host" icon={<span className="w-4 h-4 text-[#ff385c] font-bold text-base leading-none">+</span>} label="Share your home" />
                          <MenuItem to="/help"        icon={<X className="w-4 h-4 rotate-45" />} label="Help" />
                        </>
                      )}
                    </motion.div>
                  </>
