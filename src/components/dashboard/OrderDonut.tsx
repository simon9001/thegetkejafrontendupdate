...
const data = [
    { name: 'verified', value: 50, color: '#DD6E42' },
    { name: 'pending', value: 30, color: '#E8DAB2' },
    { name: 'disputed', value: 20, color: '#4A5568' },
];

const OrderDonut: React.FC = () => {
    return (
        <div className="bg-[#50757A] p-4 md:p-8 rounded-[24px] border border-[#50757A] w-full h-auto min-h-[350px] md:h-[400px]">
            <div className="flex justify-between items-center mb-6 md:mb-8">
                <p className="text-gray-500 text-[10px] font-bold uppercase tracking-widest opacity-60">Distribution</p>
                <div className="flex bg-[#50757A] p-0.5 md:p-1 rounded-lg border border-[#50757A]">
                    <button className="px-2 md:px-3 py-1 text-[10px] font-bold text-[#DD6E42] bg-[#DD6E42]/10 rounded-md">Day</button>
