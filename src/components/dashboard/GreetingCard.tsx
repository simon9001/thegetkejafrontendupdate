...
const GreetingCard: React.FC = () => {
    ...
    const getRoleBadgeColor = () => {
        switch (user?.roles?.[0]) {
            ...
            case 'landlord': return 'from-[#DD6E42]/20 to-[#C0D6DF]/20 text-[#DD6E42] border-[#DD6E42]/30';
    ...
    return (
        <div className="relative overflow-hidden bg-[#50757A] rounded-[32px] border border-[#50757A] p-8 shadow-2xl shadow-black/40 group">
            {/* Background Decorative Gradients */}
            <div className="absolute top-0 right-0 w-96 h-96 bg-[#DD6E42]/10 rounded-full -mr-48 -mt-48 blur-3xl group-hover:bg-[#DD6E42]/15 transition-all duration-700"></div>
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="space-y-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-1.5 text-gray-500 text-[10px] font-bold uppercase tracking-wider">
                            <Sparkles size={12} className="text-[#DD6E42]" />
                    ...
                    <div>
                        <h2 className="text-4xl md:text-5xl font-black text-white tracking-tight">
                            {greeting()}, <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-[#DD6E42]">{user?.full_name?.split(' ')[0]}</span>
                        </h2>
                        <p className="text-[#DD6E42] font-bold mt-2 tracking-wide uppercase text-xs opacity-90">
                            {getRoleMessage()}
                        </p>
                    </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                    <div className="flex items-center gap-3 bg-[#50757A] px-5 py-3.5 rounded-2xl border border-[#50757A] shadow-inner shadow-black/20">
                        <div className="p-2 bg-[#DD6E42]/10 rounded-lg text-[#DD6E42]">
                            <Calendar size={18} />
                        </div>
            ...
            {/* Animated Underline */}
            <div className="absolute bottom-0 left-8 right-8 h-1 bg-gradient-to-r from-transparent via-[#DD6E42]/30 to-transparent transform scale-x-0 group-hover:scale-x-100 transition-transform duration-1000"></div>
        </div>
    );
};
